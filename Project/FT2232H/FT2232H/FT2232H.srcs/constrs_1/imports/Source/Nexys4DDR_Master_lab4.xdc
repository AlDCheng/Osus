...
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { JB_IN[1] }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { JB_OUT[0] }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { JB_OUT[1] }]; #IO_L15P_T2_DQS_15 Sch=jb[4]
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { JB_OUT[2] }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { JB_IN[0] }]; #IO_L13P_T2_MRCC_15 Sch=jb[10]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {JB_IN_IBUF[0]}]
##Pmod Header JC
...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {JD_IBUF[7]}]

#set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { JD_IN[0] }]; #IO_L13N_T2_MRCC_35 Sch=jd[10]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {JD_IN_IBUF[0]}]
##set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { JD_IN[0] }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { JD_IN[1] }]; #IO_L17P_T2_35 Sch=jd[2]

#set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports { JD_OUT[0] }]; #IO_L17N_T2_35 Sch=jd[3]

#set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { JD_OUT[1] }]; #IO_L20N_T3_35 Sch=jd[4]
#set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { JD_OUT[2] }]; #IO_L15P_T2_DQS_35 Sch=jd[7]
##set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { JD_OUT[3] }]; #IO_L20P_T3_35 Sch=jd[8]
##set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { JD_OUT[4] }]; #IO_L15N_T2_DQS_35 Sch=jd[9]
##set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { JD_OUT[5] }]; #IO_L13N_T2_MRCC_35 Sch=jd[10]
